...
import { Mail, Phone, MapPin, Github, Linkedin, Send, MessageCircle, Heart, Building2 } from 'lucide-react';
          ...
          <div className={isVisible ? 'animate-fadeInRight delay-200' : 'opacity-0'}>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                className="group relative w-full flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg font-semibold hover:scale-105 transition-all overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed text-white"
              >
