...
import { ExternalLink, Github, Star, Code2, Rocket, Layers, Database } from 'lucide-react';
...
export default function Projects({ language, darkMode }: ProjectsProps) {
  ...
  const projects = [
    ...
    },
    {
      ...
      icon: Database,
      tech: ['Django REST Framework', 'Dbeaver', 'PostgreSQL', 'Celery', 'Redis', 'Microsoft Graph API', 'MSAL', 'JWT', 'Docker'],
    ...
    },
    {
      ...
      icon: Layers,
      tech: ['Next.js 14', 'React 18', 'Tailwind CSS', 'Recharts', 'React Flow', 'MSAL', 'Azure AD', 'Microsoft Graph API'],
      ...
      <div className="max-w-7xl mx-auto w-full">
            ...
            return (
              ...
              >
                ...
                <div className={`relative h-48 bg-gradient-to-br ${project.gradient} flex items-center justify-center overflow-hidden`}>
                  ...
                  <Icon className={`relative z-10 w-20 h-20 text-white transition-all duration-500 ${
        ...
        <div className={`text-center mt-12 ${
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-8 py-3 rounded-full bg-gradient-to-r from-purple-600 to-blue-600 hover:scale-105 transition-all hover:shadow-lg hover:shadow-purple-500/50 group"
          >
