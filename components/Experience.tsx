...
export default function Experience({ language, darkMode }: ExperienceProps) {
  ...
  const achievements = [
    { title: '3rd Place - Digieduhack', team: 'Team HeaRead', role: 'Full Stack Developer', icon: '🥉', color: 'from-orange-500 to-red-500' },
    { title: '3rd Place - Secure Tomorrow Hackathon', team: 'Team Futurist', role: 'Full Stack Developer', icon: '🥉', color: 'from-purple-500 to-pink-500' },
    { title: 'Google AI Hackathon', role: 'Full Stack Developer', icon: '🤖', color: 'from-blue-500 to-cyan-500' },
    { title: 'Hack4World Baku Hackathon', role: 'Full Stack Developer', icon: '🌍', color: 'from-green-500 to-emerald-500' },
    { title: 'Pasha Insurance & BANM Hackathon', role: 'Full Stack Developer', icon: '💼', color: 'from-violet-500 to-purple-500' },
    { title: '2024 Chain Reaction - FARI Solutions', role: 'Volunteer', icon: '⛓️', color: 'from-pink-500 to-red-500' }
  ];
